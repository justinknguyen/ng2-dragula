...
DragulaService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: DragulaService, deps: [{ token: DrakeFactory, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: DragulaService, decorators: [{
        ...
        return [{ type: DrakeFactory, decorators: [{
                        type: Optional
                    }] }];
    } });
...
class DragulaDirective {
    ...
    ngOnChanges(changes) {
        ...
        if (changes && changes.dragula) {
            ...
            const drake = (_a = this.group) === null || _a === void 0 ? void 0 : _a.drake;
    ...
    setup() {
        ...
        const checkModel = (group) => {
            ...
            if (this.dragulaModel) {
                if ((_a = group.drake) === null || _a === void 0 ? void 0 : _a.models) {
                    (_c = (_b = group.drake) === null || _b === void 0 ? void 0 : _b.models) === null || _c === void 0 ? void 0 : _c.push(this.dragulaModel);
                }
                else {
                    if (group.drake) {
        ...
        checkModel(group);
        (_a = group.drake) === null || _a === void 0 ? void 0 : _a.containers.push(this.container);
    ...
    teardown(groupName) {
        ...
        if (group) {
            const itemToRemove = (_a = group.drake) === null || _a === void 0 ? void 0 : _a.containers.indexOf(this.el.nativeElement);
            if (itemToRemove !== -1) {
                (_b = group.drake) === null || _b === void 0 ? void 0 : _b.containers.splice(itemToRemove, 1);
            }
...
DragulaDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: DragulaDirective, deps: [{ token: i0.ElementRef }, { token: DragulaService }], target: i0.ɵɵFactoryTarget.Directive });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: DragulaDirective, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ElementRef }, { type: DragulaService }]; }, propDecorators: { dragula: [{
                type: Input
            }], dragulaModel: [{
                type: Input
            }], dragulaModelChange: [{
...
DragulaModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: DragulaModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
DragulaModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.2", ngImport: i0, type: DragulaModule, declarations: [DragulaDirective], exports: [DragulaDirective] });
DragulaModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: DragulaModule, providers: [DragulaService] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.2", ngImport: i0, type: DragulaModule, decorators: [{
            type: NgModule,
            args: [{
